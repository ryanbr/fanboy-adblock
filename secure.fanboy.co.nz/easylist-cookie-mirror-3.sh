...
cat $MAINDIR/easylist-cookie-template.txt $COOKDIR/easylist_cookie_general_block.txt $COOKDIR/easylist_cookie_general_hide.txt $COOKDIR/easylist_cookie_thirdparty.txt $COOKDIR/easylist_cookie_specific_block.txt $COOKDIR/easylist_cookie_specific_hide.txt \
    $COOKDIR/easylist_cookie_specific_uBO.txt $COOKDIR/easylist_cookie_international_specific_hide.txt $COOKDIR/easylist_cookie_international_specific_block.txt $COOKDIR/easylist_cookie_allowlist_general_hide.txt $COOKDIR/easylist_cookie_allowlist.txt > $COOKDIR/easylist-cookie.txt
    
## ABP    
cat $MAINDIR/easylist-cookie-template.txt $COOKDIR/easylist_cookie_general_block.txt $COOKDIR/easylist_cookie_general_hide.txt $COOKDIR/easylist_cookie_thirdparty.txt $COOKDIR/easylist_cookie_specific_block.txt $COOKDIR/easylist_cookie_specific_hide.txt \
    $COOKDIR/easylist_cookie_specific_ABP.txt $COOKDIR/easylist_cookie_international_specific_hide.txt $COOKDIR/easylist_cookie_international_specific_block.txt $COOKDIR/easylist_cookie_allowlist_general_hide.txt $COOKDIR/easylist_cookie_allowlist.txt > $COOKDIR/easylist-cookie-abp.txt
