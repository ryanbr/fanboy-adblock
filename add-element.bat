...
:: Firefox
perl scripts\addChecksum.pl fanboy-adblocklist-current-expanded.txt fanboy-adblocklist-stats.txt fanboy-adblocklist-addon.txt other\chrome-addon.txt enhancedstats-addon.txt other\tracking-intl.txt
:: Firefox Regional lists
