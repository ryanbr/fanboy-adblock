...
if ((SIZE<310000)); then 
    ...
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/fanboy-adblocklist-current-expanded.txt -P $TESTDIR --output-document=$TESTDIR/firefox-expanded.txt
...
if ((SIZE<50000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/fanboy-adblocklist-stats.txt -P $TESTDIR --output-document=$TESTDIR/firefox-tracking.txt
...
if ((SIZE<40000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/fanboy-adblocklist-addon.txt -P $TESTDIR --output-document=$TESTDIR/firefox-addon.txt
...
if ((SIZE<11000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-cz.txt -P $TESTDIR --output-document=$TESTDIR/firefox-cz.txt
...
if ((SIZE<40000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-rus-v2.txt -P $TESTDIR --output-document=$TESTDIR/firefox-rus.txt
...
if ((SIZE<40000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-tky.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-turkish.txt
...
if ((SIZE<10000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-jpn.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-japanese.txt
...
if ((SIZE<50000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-krn.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-korean.txt
...
if ((SIZE<50000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-ita.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-italian.txt
...
if ((SIZE<6800)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-pol.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-polish.txt
...
if ((SIZE<10000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-ind.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-indian.txt
...
if ((SIZE<6800)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-vtn.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-vietnam.txt
...
if ((SIZE<9800)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-chn.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-chinese.txt
...
if ((SIZE<27000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-esp.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-espanol.txt
...
if ((SIZE<27000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/firefox-regional/fanboy-adblocklist-swe.txt -P $TESTDIR --output-document=$TESTDIR/fanboy-swedish.txt
...
if ((SIZE<27000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd https://fanboy-adblock-list.googlecode.com/hg/adblock-gannett.txt -P $TESTDIR --output-document=$TESTDIR/adblock-gannett.txt
...
if ((SIZE<80000)); then 
    echo "Filesize is incorrect..." > /dev/null
    wget -e robots=off -c --no-check-certificate -q --no-cache --no-cookies --referer="http://www.google.com" --user-agent=$USERAGENT -c -m -nd http://fanboy-adblock-list.googlecode.com/hg/opera/urlfilter.ini -P $TESTDIR --output-document=$TESTDIR/urlfilter.ini
