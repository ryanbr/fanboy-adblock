#!/bin/bash
#
# Fanboy Adblock Iron Convert script (espanol) v1.1 (03/09/2011)
...
#
perl $TESTDIR/opera/addChecksum-opera.pl $IRONDIR/esp/adblock.ini
perl $TESTDIR/opera/addChecksum-opera.pl $IRONDIR/esp/complete/adblock.ini
